...
class GetUserPhotosUseCaseTest : UseCaseTest() {
    @Before
    fun setup() {
        setBaseRepository(GetUserPhotosRepository::class.java)
        useCase = GetUserPhotosUseCase(repository as GetUserPhotosRepository)
    }
